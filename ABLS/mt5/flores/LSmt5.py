...
OUTPUT_DIR = "/ACL_exp/Models_LPD/mt5/flores-st-mc4-45"
os.makedirs(OUTPUT_DIR, exist_ok=True)

SIMILARITY_JSON = os.path.join(OUTPUT_DIR, "language_similarity_mt5.json")
ESCAPE_NOISE_JSON = os.path.join(OUTPUT_DIR, "escape_noise_mt5.json")
...
def main():
    ...
    # ==================
    # Stage 1: escape sigma  ✅ CHANGED to round-robin search
    # ==================
        ...
        for src_lang in langs_at_sigma:
            ...
            if not texts:
                ...
                save_similarity_progress(
                    ...
                    notes="Stage1: mean first-confuse sigma via sequential <extra_id_0> infilling + LID; Stage2: random-position <extra_id_0> fill-token prob aggregation NO renormalize. Noise: utils/noisy_mt5.py. Stage2 mask filtering: skip short/punct/symbol tokens.",
                )
                continue
